...
public class KwaraPayWeb extends Activity implements View.OnTouchListener,Handler.Callback{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webView.loadUrl("file:///android_asset/KwaraPayOfficialWebsite/index.php");
    }
    @Override
