...
public class NearestATMs extends Activity implements View.OnTouchListener,Handler.Callback{
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            webView.loadUrl("http://atm.thenearest.net/p/atm-near-ilorin-kwara-state-nigeria");
        }
        @Override
